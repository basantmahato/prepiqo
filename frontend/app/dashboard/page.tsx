...
export default function Dashboard() {
  ...
  const handleDownloadPdf = async (msgId: string) => {
    ...
    linkDiv.innerHTML = `Generated by <strong>MCQBot</strong> - <a href="${window.location.origin}" style="color: #4f46e5; text-decoration: none;">${window.location.origin}</a>`;
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-bg-secondary via-bg-secondary to-transparent pt-12 pb-6 px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-3 text-xs text-text-muted font-medium">
            MCQBot can make mistakes. Consider verifying the generated content.
          </div>
        </div>
      </div>
    </main>
