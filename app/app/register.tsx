    ...
    >
      <ScrollView contentContainerClassName="flex-grow justify-center p-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="w-full max-w-[420px] mx-auto py-8">
          ...
          <Text className="text-2xl font-bold text-center mb-2 text-[#0A2540]">Create an account</Text>
          <Text className="text-sm text-gray-500 text-center mb-8">Start generating high-quality MCQs instantly.</Text>

          {(localError || storeError) ? <Text className="text-red-500 text-center mb-4 text-sm">{localError || storeError}</Text> : null}

          <View className="mb-5">
            <Text className="text-sm font-bold text-[#0A2540] mb-2">Full Name</Text>
            <TextInput
          ...
          <View className="mb-6">
            <Text className="text-sm font-bold text-[#0A2540] mb-2">Password</Text>
            <TextInput
              className="bg-[#EEF2FF] border border-[#C7D2FE] rounded-lg px-4 py-3.5 text-sm text-gray-900"
              placeholder="••••••••"
              placeholderTextColor="#9ca3af"
          ...
          >
            ...
            />
            <Text className="text-gray-600 text-sm font-medium">Sign up with Google</Text>
          </TouchableOpacity>
          ...
          <View className="flex-row justify-center items-center mt-8">
            ...
            <Link href="/login" asChild>
              <TouchableOpacity>
                <Text className="text-sm font-medium text-[#5244E2]">Log in</Text>
              </TouchableOpacity>
            </Link>
          </View>
